...
def build_model_name():
    model_name = f'{CONFIG.DATA.DATASET}_{CONFIG.TRAIN.MAX_EPOCH}_{CONFIG.TRAIN.OPTIMIZER.LR}_{CONFIG.DATA.TRAIN_BATCH}_{CONFIG.MODEL.NAME}_{CONFIG.TRAIN.MODE}'
    model_name += '.pth'
    return model_name

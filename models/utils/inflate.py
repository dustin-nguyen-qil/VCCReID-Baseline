...
def inflate_linear(linear2d, time_dim) -> nn.Module:
    """
    Args:
...
def inflate_batch_norm(batch2d) -> nn.Module:
...
def inflate_pool(pool2d: nn.Module,
                 time_dim=1,
                 time_padding=0,
                 time_stride=None,
                 time_dilation=1) -> nn.Module:
